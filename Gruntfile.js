...
module.exports = function(grunt) {
  ...
  grunt.registerTask('default', ['clean', 'symlink:dev', 'concat:dev', 'ngAnnotate:app', 'less:dev', 'markdown', 'server', 'watch']);
  grunt.registerTask('build', ['clean', 'symlink:dist', 'concat:dist', 'ngAnnotate:app', 'uglify:dist', 'less:dist', 'markdown']);
  grunt.registerTask('deploy', ['git:add', 'git:commit', 'git:origin', 'git:heroku']);
};
